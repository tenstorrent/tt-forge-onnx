...
module @add_rs_quasar {
  ttcore.device_module {
    builtin.module @add_rs_quasar attributes {ttcore.system_desc = #system_desc, ttnn.l1_const_eval_usage = 1024 : ui64} {
      ...
      func.func @forward(%arg0: tensor<2x32x32xf32, #ttnn_layout> {ttcore.argument_type = #ttcore.argument_type<input>, ttir.name = "input_A"} loc("add_rs_quasar":0:0), %arg1: tensor<2x32x32xf32, #ttnn_layout> {ttcore.argument_type = #ttcore.argument_type<input>, ttir.name = "input_B"} loc("add_rs_quasar":0:0)) -> (tensor<2x32x32xf32, #ttnn_layout1> {ttir.name = "add_rs_quasar_1.output_Add_1"}) attributes {tt.function_type = "forward_device"} {
