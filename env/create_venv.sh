...
uv pip install wheel==0.37.1 setuptools==78.1.0
uv pip install -r "$CURRENT_SOURCE_DIR/linux_requirements.txt" -f https://download.pytorch.org/whl/cpu/torch_stable.html
