...
def compile_model(
    ...
    mlir_config = (
        ...
        .set_custom_config("l1-interleaved-fallback-analysis-enabled=1")
    )
...
def test_resnet50_benchmark():
    ...
    with _run_logging(script):
        ...
        _print_table(
            f"ResNet-50 Benchmark",
            [("ResNet-50 Benchmark", mean_infer, std_infer, mean_total, fps)],
        )
