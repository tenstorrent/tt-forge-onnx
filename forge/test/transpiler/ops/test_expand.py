...
class TestExpand:
    ...
    def test_expand_broadcasting_cases(self, opset_version, input_shape, target_shape, dtype):
        ...
        if input_shape == target_shape:
            ...
            assert (
                "Broadcast" in node_types or "Unsqueeze" in node_types
    ...
    def test_expand_no_broadcast(self, opset_version):
        ...
        assert len(identity_nodes) == 1, f"Expected 1 IdentityNode for no-broadcast case, got {len(identity_nodes)}"
