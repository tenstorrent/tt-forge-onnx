...
The f32 livelock is still open and is tracked by the f32 tests below. Note that the
cwd hypothesis was once written off -- correctly, for the f32 livelock, which it does
not explain; it is nonetheless a hard blocker on the bf16 path.
